# Level 2 Submission - Bhavesh Pal

## What I Did

I cloned the LPI developer kit repository and installed all dependencies using npm. Then I built the project and ran the test client, where all 8 tools passed successfully. After that, I installed Ollama to run a local LLM.

## Problems I Faced

While trying to run the llama3 model, I encountered a memory issue because my system did not have enough RAM to support it. To solve this, I switched to a lighter model (gemma:2b), which worked successfully on my system.

## What I Learned

I learned how to set up and run a local LLM using Ollama and how to handle system limitations by choosing appropriate models. I also understood how the SMILE methodology structures complex AI workflows into simple and practical steps.
...
What surprised me about SMILE was how structured and practical it is. Instead of only focusing on technology, it emphasizes understanding the system, the context, and the real-world purpose first. It feels like a useful framework for building systems that not only model reality but also help improve it.
