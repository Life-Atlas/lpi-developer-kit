...
def _get_expected_password():
    try:
        ...
        from dotenv import load_dotenv
        load_dotenv()
        return os.getenv("APP_PASSWORD", "level-6shubham")
...
def check_password():
    ...
    with col:
        ...
        st.markdown("## Shubham Kumar — Level 6")
        st.markdown(
            '<p style="font-size:1rem;color:#374151;margin:0.25rem 0 1rem 0">'
            'Factory Knowledge Graph Dashboard</p>',
            unsafe_allow_html=True,
        )
        st.markdown(
            """
<div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:10px;
            padding:1rem 1.25rem;margin-bottom:1rem;font-size:0.875rem;color:#374151;
            line-height:1.7">
<p style="margin:0 0 0.6rem 0">
A Neo4j knowledge graph built from real Swedish steel factory data —
<strong>8 projects, 9 stations, 13 workers, 8 weeks</strong> —
visualised as a 5-page interactive Streamlit dashboard.
</p>
<table style="width:100%;border-collapse:collapse;font-size:0.8rem;color:#475569">
  <tr style="border-bottom:1px solid #e2e8f0">
    <td style="padding:0.3rem 0.5rem 0.3rem 0;font-weight:600;white-space:nowrap;color:#0f172a">Project Overview</td>
    <td style="padding:0.3rem 0">Planned vs actual hours, variance %, products &amp; unit output</td>
  </tr>
  <tr style="border-bottom:1px solid #e2e8f0">
    <td style="padding:0.3rem 0.5rem 0.3rem 0;font-weight:600;white-space:nowrap;color:#0f172a">Station Load</td>
    <td style="padding:0.3rem 0">Variance heatmap (stations × weeks) + drill-down analytics</td>
  </tr>
  <tr style="border-bottom:1px solid #e2e8f0">
    <td style="padding:0.3rem 0.5rem 0.3rem 0;font-weight:600;white-space:nowrap;color:#0f172a">Capacity Tracker</td>
    <td style="padding:0.3rem 0">Capacity vs demand, deficit weeks, workforce composition</td>
  </tr>
  <tr style="border-bottom:1px solid #e2e8f0">
    <td style="padding:0.3rem 0.5rem 0.3rem 0;font-weight:600;white-space:nowrap;color:#0f172a">Worker Coverage</td>
    <td style="padding:0.3rem 0">SPOF detection, qualification matrix, cascade risk analysis</td>
  </tr>
  <tr>
    <td style="padding:0.3rem 0.5rem 0.3rem 0;font-weight:600;white-space:nowrap;color:#0f172a">Self-Test</td>
    <td style="padding:0.3rem 0">6 automated checks against the live Neo4j graph, scored /20</td>
  </tr>
</table>
<p style="margin:0.75rem 0 0 0;font-size:0.75rem;color:#94a3b8">
9 node labels · 11 relationship types · 143 nodes · 413 relationships
</p>
</div>
""",
            unsafe_allow_html=True,
        ...
        st.caption(
            "Password available in the project README — "
            "github.com/Life-Atlas/lpi-developer-kit/tree/master/submissions/shubham-kumar/level6"
        )
